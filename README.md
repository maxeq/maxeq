### Hi, I'm Maksims 👋 — Applied AI / Full-Stack Engineer
...
**🧠 Applied & biometric ML** — metric learning (ArcFace / SubCenter ArcFace / SupCon) on InceptionTime, ONNX with score calibration baked into the graph, on-device inference, Modal serverless GPU.

**⚡ Real-time / AI products** — OpenAI Realtime voice, RAG over pgvector, WebSockets/SSE. Built **Diligentify** — a live AI voice-interview SaaS, solo end-to-end.

**Stack:** TypeScript · Python · Node.js · Next.js · ONNX / TensorFlow · secp256k1 · OIDC/SAML · Azure · Docker

🔗 [diligentify.com](https://diligentify.com) · [Portfolio](https://portfolio-maxeqs-projects.vercel.app) · [LinkedIn](https://www.linkedin.com/in/maksims-volo%C5%A1%C4%8Duks-13152656/)
